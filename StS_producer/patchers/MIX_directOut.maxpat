...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1113.0, 160.0, 92.0, 22.0 ],
					"text" : "prepend enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1113.0, 130.0, 70.0, 22.0 ],
					"text" : "r enableDO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1021.0, 160.0, 81.0, 22.0 ],
					"text" : "prepend level"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1021.0, 130.0, 59.0, 22.0 ],
					"text" : "r levelDO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 906.0, 130.0, 92.0, 22.0 ],
					"text" : "receive~ toDO4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 781.0, 130.0, 92.0, 22.0 ],
					"text" : "receive~ toDO3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 656.0, 130.0, 92.0, 22.0 ],
					"text" : "receive~ toDO2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 531.0, 130.0, 92.0, 22.0 ],
					"text" : "receive~ toDO1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 1 ],
					"midpoints" : [ 1122.5, 192.0, 812.5, 192.0 ],
					"order" : 2,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 1 ],
					"midpoints" : [ 1122.5, 192.0, 937.5, 192.0 ],
					"order" : 3,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 1 ],
					"midpoints" : [ 1122.5, 192.0, 564.0, 192.0 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 1122.5, 192.0, 687.5, 192.0 ],
					"order" : 1,
					"source" : [ "obj-16", 0 ]
				}
